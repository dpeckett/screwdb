...
#define btree_get(bt, key, data) btree_txn_get(bt, NULL, key, data)
#define btree_put(bt, key, data, flags)                                        \
  btree_txn_put(bt, NULL, key, data, flags)
#define btree_del(bt, key, data) btree_txn_del(bt, NULL, key, data)
...
#define btree_cursor_open(bt) btree_txn_cursor_open(bt, NULL)
